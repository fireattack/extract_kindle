...
SYM_NAMES = [ 'com.amazon.drm.Envelope@1.0',
            ...
            #this assumes there are no new types added aside from voucher envelopes. So far it was largely correct
                   for n in list(range(2, 29)) +
                   [9708, 1031, 2069, 9041, 3646,
                    6052, 9479, 9888, 4648, 5683, 7384, 2746, 3332]+list(range(10001, 11111))]
